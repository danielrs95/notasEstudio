...
Las clases anonimas son una forma de instanciar clases abstractas sin necesidad de usar sus clases hijas

Su ciclo de vida no es duradero, no las tendremos disponibles durante toda la ejecucion del programa
...
A partir de Java 8, podemos tener implementacion en metodos para heredar y retuilizar diferentes comportamientos

No todos los metodos de nuestras interfaces deben ser abstractos, ahora podemos usar el modificador de acceso `default` y desde Java 9 `private`
